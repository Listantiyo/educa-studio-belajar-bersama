        ...
        <div class="right-siderbar-common">
            <div class="top-members">
                ...
                <ul>
                    <li>
                        <a href="groups.html">
                            <img src="{{asset('pify/assets/images/user/user-8.jpg')}}" alt="Image">
                    ...
                    <li>
                        <a href="groups.html">
                            <img src="{{asset('pify/assets/images/user/user-9.jpg')}}" alt="Image">
                    ...
                    <li>
                        <a href="groups.html">
                            <img src="{{asset('pify/assets/images/user/user-10.jpg')}}" alt="Image">
                    ...
                    <li>
                        <a href="groups.html">
                            <img src="{{asset('pify/assets/images/user/user-11.jpg')}}" alt="Image">
                    ...
                    <li>
                        <a href="groups.html">
                            <img src="{{asset('pify/assets/images/user/user-12.jpg')}}" alt="Image">
        ...
        <div class="right-siderbar-common">
            <div class="ads">
                <a href="queations-details.html">
                    <img src="{{asset('pify/assets/images/ad.jpg')}}" alt="Image">
                </a>
