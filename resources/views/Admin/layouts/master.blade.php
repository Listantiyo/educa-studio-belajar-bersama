...
<div class="wrapper">
  ...
  <!-- Preloader -->
  <div class="dark-mode preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('pify/assets/images/logo.png')}}" alt="AdminLTELogo">
  </div>
